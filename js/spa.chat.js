...
spa.chat = (function () {
    ...
    var setJqueryMap,
        ...
        setSliderPosition, removeSlider, handleResize,
        onClickToggle,
    ...
    // ---------------- BEGIN DOM METHODS -----------------------------
    // Begin DOM method /setJqueryMethod/
    ...
    // End DOM method /setJqueryMethod/
    ...
    //  The callback receiveds a jQuery collection representing the slider div as its single argument
    // Action       :
    ...
    // Returns      :
    //  * ture - The requested position was achieved
    ...
    removeSlider = function () {
        ...
        // remove DOM container; this remove event bingds too
        if (jqueryMap.$slider) {
    ...
    // Begin DOM method /handleResize/
    // Purpose      : Given a window resize event, adjust the presentation provided by this module if needed
    // Actions      :
    //  If the window height or width falls below a given threshold, resize the chat silder for
    //  the reduced window size.
    // Returns      : Boolean
    //  * true - resize not considered
    //  * false - resize considered
    // Throws       : none
    //
    ...
    initModule = function ($append_target) {
        ...
        // initialize chat slider to default title an state
